#!/usr/bin/env python3
# rootfs/apps/crystal-browser/main.py  --  Crystal Browser v1.0
...
def fetch(url):
    ...
    try:
        req=urllib.request.Request(url,headers={"User-Agent":"CrystalBrowser/1.0 PocketMint"})
...
def main():
    ...
    pygame.display.set_caption("Crystal Browser"); clock=pygame.time.Clock()
